	...
	<div class="container">
      ...
      <div class="row">
        <div class="input-field col s12">
          <input id="judul_berita" name="judul_berita" type="text" class="">
	 ...
	 <div class="row">
	      <div class="row">
	        <div class="input-field col s12">
	          <textarea id="textarea1" name="isi_berita" class="materialize-textarea"></textarea>
